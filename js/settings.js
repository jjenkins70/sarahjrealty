...
jQuery(document).ready(function(){
	...
	jQuery(window).scroll(function () {
		...
		if (skillsTop > 0) {
			...
			jQuery(".level_1 .bar div").animate({width: "2%"}, 1500);
			jQuery(".level_2 .bar div").animate({width: "12%"}, 1500);
			jQuery(".level_3 .bar div").animate({width: "22%"}, 1500);
			jQuery(".level_4 .bar div").animate({width: "32%"}, 1500);
			jQuery(".level_5 .bar div").animate({width: "42%"}, 1500);
			jQuery(".level_6 .bar div").animate({width: "52%"}, 1500);
			jQuery(".level_7 .bar div").animate({width: "62%"}, 1500);
			jQuery(".level_8 .bar div").animate({width: "72%"}, 1500);
			jQuery(".level_9 .bar div").animate({width: "82%"}, 1500);
			jQuery(".level_10 .bar div").animate({width: "92%"}, 1500);
